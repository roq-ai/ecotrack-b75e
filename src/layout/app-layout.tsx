...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'team-member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Activity', path: '/activities', entity: 'activity', service: AccessServiceEnum.PROJECT, icon: FiActivity },
    { name: 'Goal', path: '/goals', entity: 'goal', service: AccessServiceEnum.PROJECT, icon: FiTarget },
    { name: 'Reward', path: '/rewards', entity: 'reward', service: AccessServiceEnum.PROJECT, icon: FiGift },
